  ...
  return (
    <main>
      ...
      <section style={{ color: "#FAFAF7", position: "relative", overflow: "hidden", isolation: "isolate" }}>
        ...
        <div className="cx-seam-top" aria-hidden />
        <div className="cx-seam-bottom" aria-hidden />
        <div style={{ position: "relative", zIndex: 2, maxWidth: 1320, margin: "0 auto", padding: SECTION_PAD }}>
      ...
      {/* ===================== THE SHIFT ===================== */}
      <section style={{ background: "#FAFAF7", padding: SECTION_PAD }}>
        <div style={{ maxWidth: 1320, margin: "0 auto" }}>
          <div data-reveal style={{ maxWidth: 760, marginBottom: "clamp(48px, 6vw, 72px)" }}>
            <h2 style={{ fontFamily: SERIF, fontWeight: 500, fontSize: "clamp(34px, 5vw, 60px)", lineHeight: 1.02, letterSpacing: "-0.035em", color: "#13294B", margin: 0, textWrap: "balance" }}>The same clinic, two very different weeks.</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 1, background: "rgba(19,41,75,0.08)", border: "1px solid rgba(19,41,75,0.08)", borderRadius: 20, overflow: "hidden", boxShadow: "0 12px 40px rgba(19,41,75,0.06)" }}>
            <div data-reveal style={{ background: "#F6F4EF", padding: "clamp(30px, 3.5vw, 50px)" }}>
      ...
      <section id="capabilities" style={{ background: "#FAFAF7", padding: SECTION_PAD }}>
        <div style={{ maxWidth: 1320, margin: "0 auto" }}>
          <div data-reveal style={{ maxWidth: 800, marginBottom: "clamp(48px, 6vw, 76px)" }}>
            <h2 style={{ fontFamily: SERIF, fontWeight: 500, fontSize: "clamp(34px, 5vw, 60px)", lineHeight: 1.02, letterSpacing: "-0.035em", color: "#13294B", margin: "0 0 20px", textWrap: "balance" }}>Everything your front and back office runs on — handled.</h2>
      ...
      {/* ===================== PROCESS ===================== */}
      <section id="process" style={{ background: "#FAFAF7", padding: SECTION_PAD }}>
        <div style={{ maxWidth: 1320, margin: "0 auto" }}>
          <div data-reveal style={{ maxWidth: 720, marginBottom: "clamp(48px, 6vw, 72px)" }}>
            <h2 style={{ fontFamily: SERIF, fontWeight: 500, fontSize: "clamp(34px, 5vw, 60px)", lineHeight: 1.04, letterSpacing: "-0.035em", color: "#13294B", margin: 0, textWrap: "balance" }}>From first call to fully embedded, in four steps.</h2>
          </div>
          <div data-stagger style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(248px, 1fr))", gap: 20 }}>
            {STEPS.map((step) => (
              <div key={step.num} className="cx-card" style={{ padding: "32px 30px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 22 }}>
                  <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 38, height: 38, borderRadius: 11, background: "rgba(19,41,75,0.05)", fontFamily: SERIF, fontWeight: 600, fontSize: 18, color: "#13294B" }}>{step.num}</span>
                  <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.02em", color: "#5B8C7B", background: "rgba(91,140,123,0.1)", padding: "4px 10px", borderRadius: 999 }}>{step.tag}</span>
                </div>
                <div style={{ fontFamily: SERIF, fontWeight: 600, fontSize: 20, color: "#13294B", marginBottom: 10, letterSpacing: "-0.01em" }}>{step.title}</div>
                <p style={{ fontSize: "14.5px", lineHeight: 1.6, color: "#4A4A45", margin: 0 }}>{step.body}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ maxWidth: 1320, margin: "0 auto" }}>
          ...
          <div data-stagger style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16, marginBottom: "clamp(28px, 3.5vw, 40px)" }}>
            {[
              ...
              <div key={c.tag} className="cx-card" style={{ padding: "24px 24px" }}>
          ...
          <div data-reveal className="cx-calc-grid" style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 0, border: "1px solid rgba(19,41,75,0.1)", borderRadius: 24, overflow: "hidden", boxShadow: "0 24px 56px rgba(19,41,75,0.09)" }}>
            <div style={{ background: "#FFFFFF", padding: "clamp(28px, 3.5vw, 48px)" }}>
      ...
      <section id="compliance" style={{ background: "#0C1E3C", color: "#FAFAF7", padding: SECTION_PAD, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 1320, margin: "0 auto" }}>
          <h2 data-reveal style={{ fontFamily: SERIF, fontWeight: 500, fontSize: "clamp(34px, 5.4vw, 68px)", lineHeight: 1.02, letterSpacing: "-0.04em", color: "#FAFAF7", margin: "0 0 clamp(44px, 5vw, 64px)", maxWidth: "20ch", textWrap: "balance" }}>For us, HIPAA is built into the <span style={{ color: "#FEC539" }}>architecture</span> — not added at the end.</h2>
          <div data-stagger style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 14 }}>
            {COMPLIANCE_STATS.map((c) => (
              <div key={c.value} style={{ background: "rgba(250,250,247,0.04)", border: "1px solid rgba(250,250,247,0.1)", borderRadius: 16, padding: "28px 26px" }}>
                <div style={{ fontFamily: SERIF, fontWeight: 600, fontSize: "clamp(32px, 4vw, 46px)", color: "#FEC539", lineHeight: 1, letterSpacing: "-0.02em" }}>{c.value}</div>
                <div style={{ fontSize: "13.5px", lineHeight: 1.5, color: "rgba(250,250,247,0.72)", marginTop: 14 }}>{c.label}</div>
              </div>
            ))}
          </div>
      ...
      {/* ===================== FAQ ===================== */}
      <section id="faq" style={{ background: "#FAFAF7", padding: SECTION_PAD }}>
