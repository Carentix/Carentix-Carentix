...
export function BaaPage() {
  useScrollTop();
  useDocumentHead(PAGE_SEO.baa);
  return (
    <>
      <PageHero
        image="/images/hero-baa.png"
      ...
      <div className="mx-auto max-w-[820px] px-8 pb-24">
        ...
        <DocSection eyebrow="Contact" title="Request the full template">
          <p>
            Compliance office —{" "}
            <a className="font-medium text-sage underline-offset-2 hover:underline" href="mailto:compliance@carentix.com">
