...
export function CareersPage() {
  useScrollTop();
  useDocumentHead({
    title: "Careers — Build a Real Career in Healthcare Operations | Carentix",
    description:
      "Not gig work. Structured onboarding, a 1:8 supervisor ratio, eight named compliance training modules, and a path that grows with you. See open remote roles at Carentix.",
    path: "/careers",
    image: "/images/hero-career.webp",
  });
