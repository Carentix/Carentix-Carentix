...
import { absoluteUrl, CONTACT_EMAIL, SITE_LEGAL_NAME, SITE_URL } from "@/lib/site";
import {
  AFTER_ITEMS,
  BEFORE_ITEMS,
  CAPABILITY_TAGS,
...
/** Organization structured data — home route only. */
const ORGANIZATION_JSONLD = {
  "@context": "https://schema.org",
  "@type": "Organization",
  name: SITE_LEGAL_NAME,
  alternateName: "Carentix",
  url: SITE_URL,
  logo: absoluteUrl("/favicon.svg"),
  image: absoluteUrl("/images/hero-home.webp"),
  description:
    "Carentix is a healthcare operations partner providing revenue cycle management, prior authorization, credentialing, and HIPAA-compliant administrative support to medical practices.",
  email: CONTACT_EMAIL,
  areaServed: "US",
  knowsAbout: [
...
export function HomePage() {
  useScrollTop();
  useDocumentHead({
    title: "Carentix — Your Healthcare Operations Partner",
    description:
      "A dedicated, supervised care team that owns scheduling, prior authorizations, scribing, and records — so your providers can focus entirely on patients. HIPAA-compliant by design.",
    path: "/",
      ...
      <section id="top" className="relative overflow-hidden bg-navy-deep">
        ...
        <div className="relative z-10 mx-auto max-w-site px-8 pb-16 pt-[148px] md:pb-[104px] md:pt-[236px]">
          <div className="max-w-[630px]">
            <Reveal className="mb-7 inline-flex items-center gap-2.5 rounded-full border border-sage/30 bg-sage/10 px-[15px] py-2 md:mb-10">
              ...
              <span className="text-[13px] font-medium text-sage-text">
        ...
        <Reveal className="relative z-10 border-y border-navy/10 bg-paper/90 backdrop-blur-sm backdrop-saturate-150">
          <div className="mx-auto flex max-w-site flex-wrap items-center gap-x-6 gap-y-3.5 px-8 py-5">
            <span className="text-[11.5px] font-semibold uppercase tracking-[0.12em] text-sage-text">
              Our team handles
            </span>
            ...
            {STEPS.map((step) => (
              ...
              >
                <div className="mb-6 flex items-baseline gap-3">
                  ...
                  <span className="rounded-full bg-sage/[0.12] px-2.5 py-1 text-[11px] font-semibold text-sage-text">
                    {step.tag}
                  </span>
                </div>
          ...
          <Reveal className="grid items-center gap-7 md:grid-cols-[auto_1fr] md:gap-[52px]">
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3.5">
                ...
                <span className="inline-flex items-center gap-1.5 rounded-full bg-sage/[0.12] px-2.5 py-1 text-xs font-semibold text-sage-text">
