...
export function TermsPage() {
  ...
  useDocumentHead({
    ...
    description:
      "The terms governing use of the Carentix website and the engagement of Carentix healthcare operations services, including scope, billing, and termination.",
    path: "/terms",
    image: "/images/hero-terms.webp",
  });
  return (
    <>
      <PageHero
      ...
      <div className="mx-auto max-w-[820px] px-8 pb-24">
        ...
        <DocSection eyebrow="Contact" title="Questions about these terms">
          <p>
            Legal —{" "}
            <a className="font-medium text-sage-text underline-offset-2 hover:underline" href="mailto:legal@carentix.com">
              legal@carentix.com
            </a>
          </p>
