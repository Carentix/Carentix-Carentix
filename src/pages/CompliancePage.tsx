...
export function CompliancePage() {
  useScrollTop();
  useDocumentHead(PAGE_SEO.compliance);
            ...
            {MODULES.map((m) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="mt-1 text-[11.5px] font-semibold uppercase tracking-wide text-sage">
                    {m.tag}
                  </div>
                </div>
              </Reveal>
        ...
        <Reveal className="mx-auto max-w-[900px] rounded-[32px] bg-navy px-8 py-16 text-center text-paper md:px-16">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3.5">
            ...
            <Button asChild variant="ghost" size="lg">
              <a href="#">Download Compliance Overview (PDF)</a>
            </Button>
          </div>
        </Reveal>
      </section>
