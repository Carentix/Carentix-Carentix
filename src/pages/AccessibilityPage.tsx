...
export function AccessibilityPage() {
  useScrollTop();
  useDocumentHead({
    title: "Accessibility Statement — Carentix",
    description:
      "Carentix is committed to WCAG 2.1 AA conformance across this site — keyboard navigation, visible focus, reduced-motion support, and readable contrast. Tell us where we can do better.",
    path: "/accessibility",
    image: "/images/hero-accessibility.webp",
  });
  return (
    <>
      <PageHero
      ...
      <div className="mx-auto max-w-[820px] px-8 pb-24">
        ...
        <DocSection eyebrow="Contact" title="Tell us where we can do better">
          <p>
            ...
            <a className="font-medium text-sage-text underline-offset-2 hover:underline" href="mailto:accessibility@carentix.com">
